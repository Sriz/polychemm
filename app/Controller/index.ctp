...
<div class="panel panel-primary">
   <div class="panel-heading">
      <h3 class="panel-title">
        <strong><center>Consumption Stock</center></strong>
      </h3>
   </div>
...
?>
    <td>   <button class="btn btn-primary" onclick="window.location.href='<?php echo Router::url(array('controller'=>'ConsumptionStocks', 'action'=>'add'))?>'">Add</button>
</td>
	<td>   <button class="btn btn-primary" onclick="window.open('<?php echo Router::url(array('controller' => 'ConsumptionStocks', 'action' => 'create_mixingpdf')) ?>')">Print</button>
