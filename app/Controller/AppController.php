...
class AppController extends Controller
{
    ...
    public $components = array('Auth', 'Session', 'Error', 'Cookie', 'MobileDetect', 'FilterResults.Filter' => array(
        'auto' => array(
            'paginate' => false,
    ...
    public $helpers = array('CakeStrap' => array('className' => 'CakeStrapHtml'),
        'Form' => array('className' => 'CakeStrapForm'), 'FilterResults.Search' => array(
            'operators' => array(
                'LIKE' => 'containing',
