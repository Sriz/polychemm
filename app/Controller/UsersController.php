...
class UsersController extends AppController {
	public function beforeFilter() {
		...
		$this->Auth->allow('add', 'logout','login', 'change_password', 'remember_password', 'remember_password_step_2');
	}
	...
	public function index() {
		...
		else if(AuthComponent::user('role')=='store')
		{
		$this->User->recursive = 0;
		//this->set('users', $this->paginate());
		$this->redirect($this->Auth->redirectUrl());
		}
		else if(AuthComponent::user('role')=='mixing')
		{
		$this->User->recursive = 0;
		//this->set('users', $this->paginate());
		$this->redirect($this->Auth->redirectUrl());
		}
		else if(AuthComponent::user('role')=='scrap')
		{
		$this->User->recursive = 0;
		//this->set('users', $this->paginate());
		$this->redirect($this->Auth->redirectUrl());
		...
		else if(AuthComponent::user('role')=='calender')
		{
		$this->User->recursive = 0;
		//this->set('users', $this->paginate());
		$this->redirect($this->Auth->redirectUrl());
		...
		else if(AuthComponent::user('role')=='printing')
		{
		$this->User->recursive = 0;
		//this->set('users', $this->paginate());
		$this->redirect($this->Auth->redirectUrl());
		...
		else if(AuthComponent::user('role')=='laminating')
		{
		$this->User->recursive = 0;
		//this->set('users', $this->paginate());
		$this->redirect($this->Auth->redirectUrl());
		...
		else if(AuthComponent::user('role')=='electroic')
		{
		$this->User->recursive = 0;
		//this->set('users', $this->paginate());
		$this->redirect($this->Auth->redirectUrl());
		...
		else if(AuthComponent::user('role')=='rexin')
		{
		$this->User->recursive = 0;
		//this->set('users', $this->paginate());
		$this->redirect($this->Auth->redirectUrl());
		...
		else if(AuthComponent::user('role')=='mechanical')
		{
		$this->User->recursive = 0;
		//this->set('users', $this->paginate());
		$this->redirect($this->Auth->redirectUrl());
