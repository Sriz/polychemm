                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                echo $this->Form->input('Month', array('options'=>$months,'empty'=>'--choose one--','class' => 'month form-control', 'type' => 'select', 'onchange' => 'gets(this);'));
                                echo '</td>';
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td>Foaming Scrap</td>
                                <td><?=number_format($tblScrapDetailsToDay['magnetic_wasted'],2);?></td>
                                <td><span class=""><?=number_format(($tblScrapDetailsToDay['magnetic_wasted']*100)/$tblScrapDetailsToDay['scrap'], 2);?> %</span></td>
                                <td><?=number_format($tblScrapDetailsToMonth['magnetic_wasted'],2);?></td>
                                <td><span class=""><?=number_format(($tblScrapDetailsToMonth['magnetic_wasted']*100)/$tblScrapDetailsToMonth['scrap'], 2);?> %</span></td>
                                <td><?=number_format($tblScrapDetailsToYear['magnetic_wasted'],2);?></td>
                                <td><span class=""><?=number_format(($tblScrapDetailsToYear['magnetic_wasted']*100)/$tblScrapDetailsToYear['scrap'], 2);?> %</span></td>
                            </tr>
                            <tr>
                                <td>Final Chipps</td>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-2">
                            <table class="table">
                                <tr class="success">
                                <th>Output <small class="text-muted">(Wt per M)</small></th>
                                <?php
                        ...
                        <div class="col-md-2">
                           <table class="table">
                                ...
                                for($i=0;$i<$c;$i++):?>
                                    <tr>
                                        <td class="<?=(($output_m[$i][0][0]['output']-$dim_target[$i]['dimension_target']['target'])*100/$dim_target[$i]['dimension_target']['target'])<0?'danger':'success';?>">
                                            <?php echo number_format(($output_m[$i][0][0]['output']-$dim_target[$i]['dimension_target']['target'])*100/$dim_target[$i]['dimension_target']['target'],2)."%"; ?>
                                        </td>
                                <?php endfor;?>
                                </tr>
                            </table>
