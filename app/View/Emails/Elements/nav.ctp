...
<!--				<li><a href="tables.html"><i class="fa fa-list"></i> Activity</a></li>-->
		...
		<?php if(AuthComponent::user('id') and AuthComponent::user('role')=='store'){?>
			<ul class="nav navbar-nav side-nav">
				...
				<li class="<?php echo $this->params->params['controller'] == 'pages' ?>"><a href="<?php echo $this->params->webroot?>home"><i class="fa fa-dashboard"></i> Purchase Request</a></li>
				<!-- store menus -->
				<li class="<?php echo $this->params->params['controller'] == 'pages' ?>"><a href="<?php echo $this->params->webroot?>home"><i class="fa fa-dashboard"></i>Issues</a></li>
				<li class="<?php echo $this->params->params['controller'] == 'pages' ?>"><a href="<?php echo $this->params->webroot?>home"><i class="fa fa-dashboard"></i> View Stock</a></li>
				<li class="<?php echo $this->params->params['controller'] == 'pages' ?>"><a href="<?php echo $this->params->webroot?>home"><i class="fa fa-dashboard"></i> Add</a></li>
				<li class="<?php echo $this->params->params['controller'] == 'pages' ?>"><a href="<?php echo $this->params->webroot?>home"><i class="fa fa-dashboard"></i>Vender </a></li>	
				<li class="<?php echo $this->params->params['controller'] == 'pages' ?>"><a href="<?php echo $this->params->webroot?>home"><i class="fa fa-dashboard"></i>Material </a></li>
				<li class="<?php echo $this->params->params['controller'] == 'pages' ?>"><a href="<?php echo $this->params->webroot?>home"><i class="fa fa-dashboard"></i> Category</a></li>
