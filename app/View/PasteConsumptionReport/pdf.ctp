...
echo '<pre>';
print_r($paste_consumption_report);
exit;
...
$html = "";
$html .="<h2>Paste Consumption Reports - ".$date."</h2>";
...
$html .= "<tr>
    ...
    <td><strong>Paste TC KGS</strong></td>
    <td><strong>Paste FC KGS</strong></td>
    <td><strong>Paste AC KGS</strong></td>
    <td><strong>Paste TC GPM</strong></td>
    <td><strong>Paste FC GPM</strong></td>
    <td><strong>Paste AC GPM</strong></td>
    </tr>
";
foreach($printingShiftReport as $p):
    if($p['printing_shiftreport']['shift']=='A'):
    $html .="<tr>";
    ...
    $printed_scrap += intval($p['printing_shiftreport']['printed_scrap']);
    $unprinted_scrap += intval($p['printing_shiftreport']['unprinted_scrap']);
...
$html .="<td>".$input."</td>";
$html .="<td>".$output."</td>";
$html .="<td>".$unprinted_scrap."</td>";
$html .="<td>".$printed_scrap."</td>";
$html .="</tr>";
...
$unprinted_scrapB = 0;
foreach($printingShiftReport as $p):
    if($p['printing_shiftreport']['shift']=='B'):
    $html .="<tr>";
    $html .="<td>".$p['printing_shiftreport']['shift']."</td>";
    $html .="<td>".$p['printing_shiftreport']['dimension']."</td>";
    $html .="<td>".$p['printing_shiftreport']['PF_Color']."</td>";
    ...
    $html .="<td>".number_format($p['printing_shiftreport']['printed_scrap'])."</td>";
    $html .="</tr>";
    $inputB += intval($p['printing_shiftreport']['input']);
    $outputB += intval($p['printing_shiftreport']['output']);
    $printed_scrapB += intval($p['printing_shiftreport']['printed_scrap']);
    $unprinted_scrapB += intval($p['printing_shiftreport']['unprinted_scrap']);
    endif;
endforeach;
...
$html .="<td>".$inputB."</td>";
$html .="<td>".$outputB."</td>";
$html .="<td>".$unprinted_scrapB."</td>";
$html .="<td>".$printed_scrapB."</td>";
$html .="</tr>";
