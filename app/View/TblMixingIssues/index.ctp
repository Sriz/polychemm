                ...
                if (!count($consumptions)):
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr class="success">
                            <th>Brand</th>
                            <?php for ($i = 0; $i < count($consumptions); $i++): ?>
                                <td><?= $consumptions[$i]['TblMixingIssue']['brand']; ?></td>
                            <?php endfor; ?>
                        </tr>
                       <!--  <tr class="success">
                            <td>Colour</td>
                            <?php for ($i = 0; $i < count($consumptions); $i++): ?>
                                <td><?= $consumptions[$i]['TblMixingIssue']['colour']; ?></td>
                            <?php endfor; ?>
                        </tr> -->
                        <tr class="success">
                            <th>Coating</th>
                        ...
                        <?php foreach ($material_lists as $m): ?>
                            <tr>
                                <td class="danger"><?= $m['MixingPattern']['pattern_name']; ?></td>
                                <?php for ($i = 0; $i < count($consumptions); $i++): ?>
                                    <td>
                                        <?php
                                        $materials = json_decode($consumptions[$i]['TblMixingIssue']['patterns']);
                                            echo isset($materials->$m['MixingPattern']['id']) ? number_format($materials->$m['MixingPattern']['id'],2) ? number_format($materials->$m['MixingPattern']['id'],2) : '0.00' : '0.00';
                                        ?>
                                    </td>
                                <?php endfor; ?>
                            </tr>
