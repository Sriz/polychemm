...
<?php
function removeMultipleArray($dropdown, $name)
{
	$newArr = array();
	foreach($dropdown as $d)
	{
		$newArr[$d['rexin_dropdown'][$name]] = $d['rexin_dropdown'][$name];
	}
	return $newArr;
}
...
<div class="products form col-md-12">
	<?php echo $this->Html->link(__('List CoatingProductionReports'), array('action' => 'index'),['class'=>'btn btn-primary pull-right']); ?>
	...
	<?=$this->Form->hidden('id');?>
	<fieldset>
		<legend><?php echo __('Add CoatingProductionReport'); ?></legend>
		<table class="table">
			<tr>
				<td>Shift</td>
			...
			<tr>
				<td>Brand</td>
				<td><?=$this->Form->input('brand', ['options'=>removeMultipleArray($dropdown['brand'], 'brand'), 'empty'=>'--choose one--','required'=>'required' ,'label'=>false, 'onchange'=>'return change_colour(this);']);?></td>
			</tr>
			<tr>
				<td>Colour</td>
				<td><?=$this->Form->input('colour', ['options'=>removeMultipleArray($dropdown['colour'], 'colour'), 'empty'=>'--choose one--','required'=>'required' ,'label'=>false, 'onchange'=>'return change_embossing();']);?></td>
			</tr>
			<tr>
				<td>Embossing</td>
				<td><?=$this->Form->input('embossing', ['options'=>removeMultipleArray($dropdown['embossing'], 'embossing'), 'empty'=>'--choose one--','required'=>'required' ,'label'=>false , 'onchange'=>'return change_r_paper();']);?></td>
			</tr>
			<tr>
				<td>R. Paper</td>
				<td><?=$this->Form->input('r_paper', ['options'=>removeMultipleArray($dropdown['r_paper'], 'r_paper'), 'empty'=>'--choose one--','required'=>'required' ,'label'=>false, 'onchange'=>'return change_fabric();']);?></td>
			</tr>
			<tr>
				<td>Fabric</td>
				<td><?=$this->Form->input('fabric', ['options'=>removeMultipleArray($dropdown['fabric'], 'fabric'), 'empty'=>'--choose one--','required'=>'required' ,'label'=>false , 'onchange'=>'return change_thickness();']);?></td>
			</tr>
			<tr>
				<td>Thickness</td>
				<td><?=$this->Form->input('thickness', ['options'=>removeMultipleArray($dropdown['thickness'], 'thickness'), 'empty'=>'--choose one--','required'=>'required' ,'label'=>false]);?></td>
			</tr>
			<tr>
				<td>Width</td>
