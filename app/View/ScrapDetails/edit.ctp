...
<?php echo $this->Form->create(null,array(
	'url' => array('controller' => 'ScrapDetails', 'action' => 'edit'),
	...
	<fieldset>
		<legend><?php echo __('Edit Scrap Detail'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ScrapDetail.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ScrapDetail.id'))); ?></li>
